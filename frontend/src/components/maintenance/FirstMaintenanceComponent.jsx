import "../../styles/maintenance/FirstMaintenanceComponent.css";
    ...
    return (
        <div className="first-maintenance-component">
            ...
            <section>
                ...
                <p>Découvrez nos différentes offres allant d’un simple nettoyage à une révision complète de toute votre collection.</p>
            </section>
        </div>
    )
}